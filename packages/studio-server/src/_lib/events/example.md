...
Create an events file like this:
...
Then extend BaseEventDispatcher like this:
...
export class StudioEventDispatcher extends BaseEventDispatcher<DispatchedEvent> {
    constructor(
