...
@bt-studio/core provides first-class JSX/TSX support for defining behavior trees with a declarative, visual syntax while maintaining full type safety and IDE autocomplete.

## Setup

### 1. Configure `tsconfig.json`

Tell TypeScript to use the @bt-studio/core JSX factory:
...
```tsx
import { Timeout, Repeat } from '@bt-studio/core';
